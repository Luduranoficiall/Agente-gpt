...
CONNECTORS = [
  {"name": "Supermercados", "env": "ECONOMIA_SUPERMARKET_API_KEY", "categoria": "supermercados"},
  {"name": "Postos de combustível", "env": "ECONOMIA_GAS_API_KEY", "categoria": "postos"},
    ...
    mapped.append(
      {
        ...
        "variavel": item["env"],
        "status": status,
        "observacao": "Token válido" if token else "Informe o token/API key no .env",
      }
    )
  return mapped
